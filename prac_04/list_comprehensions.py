...
# TODO: use a list comprehension to create a list of only the numbers that are greater than 9
#  from the numbers (not strings) you just created
num_more_than_9 = [num for num in numbers if num > 9]
print(num_more_than_9)
